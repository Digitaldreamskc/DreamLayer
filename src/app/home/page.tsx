    ...
    const navigationSections = [
        {
            ...
            description: 'Join exclusive events and earn POAPs',
        ...
        },
        {
            key: 'mint-dynamic',
            title: 'Dynamic NFTs',
            subtitle: 'ERC-7160 + ERC-6551',
            description: 'Create evolving NFTs with token-bound accounts',
        ...
        },
        {
            key: 'mint-ip',
            title: 'Register IP',
            subtitle: 'Story Protocol',
            description: 'Mint and license intellectual property assets',
        ...
        },
        {
            ...
            description: 'Manage your dynamic identity',
            ...
            <main className="pt-20 relative z-10">
                ...
                <section className="relative min-h-screen flex items-center justify-center px-6">
                    <div className="max-w-6xl mx-auto text-center">
                        <div className={`space-y-8 mb-16 transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
                            }`}>
                            ...
                            <p className="text-xl md:text-2xl text-white/70 font-light max-w-3xl mx-auto leading-relaxed">
                                The next gen platform for building, learning, and connecting with the future of decentralized technology
                            </p>
                        </div>
                        ...
                        <div className={`flex flex-col sm:flex-row gap-6 justify-center transition-all duration-1000 delay-500 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
                            ...
                            >
                                <div className={`absolute inset-0 bg-gradient-to-r from-blue-600 to-cyan-600 transition-all duration-500 ${hoveredCard === 'events-cta' ? 'opacity-100 scale-105' : 'opacity-90'
                                    }`} />
                            ...
                            >
                                <div className={`absolute inset-0 bg-white/[0.08] backdrop-blur-xl border border-white/20 transition-all duration-500 ${hoveredCard === 'learn-cta' ? 'bg-white/[0.12] border-white/30' : ''
                                    }`} />
                    ...
                    <div className="max-w-7xl mx-auto">
                        ...
                        <div className="grid lg:grid-cols-2 gap-8 mb-16">
                            ...
                            <div
                                ...
                                onMouseLeave={() => setHoveredCard(null)}
                            >
                                <div className={`absolute inset-0 bg-gradient-to-r from-blue-600/20 to-cyan-600/20 rounded-3xl blur-2xl transition-all duration-700 ${hoveredCard === 'featured-event' ? 'opacity-60 scale-105' : 'opacity-0'
                                    }`} />
                                <div className="relative bg-white/[0.02] backdrop-blur-xl border border-white/10 rounded-3xl p-8 group-hover:bg-white/[0.04] group-hover:border-white/20 transition-all duration-500">
                                    ...
                                    <p className="text-white/70 mb-6 leading-relaxed">
                                        Join industry leaders for an exclusive gathering featuring the latest in innovation & explore what's possible.'
                                    </p>
                                    ...
                                    <div className="grid grid-cols-3 gap-4 mb-6">
                                        <div className="text-center p-4 bg-gradient-to-br from-blue-600/20 to-cyan-600/20 rounded-2xl border border-blue-500/30">
                                            ...
                                            <div className="text-lg font-bold text-white">Aug 13</div>
                                        </div>
                                        <div className="text-center p-4 bg-gradient-to-br from-purple-600/20 to-pink-600/20 rounded-2xl border border-purple-500/30">
                                            ...
                                            <div className="text-lg font-bold text-white">MOD Gallery</div>
                                        </div>
                            ...
                            <div
                                ...
                                onMouseLeave={() => setHoveredCard(null)}
                            >
                                <div className={`absolute inset-0 bg-gradient-to-r from-emerald-600/20 to-teal-600/20 rounded-3xl blur-2xl transition-all duration-700 ${hoveredCard === 'featured-quest' ? 'opacity-60 scale-105' : 'opacity-0'
                                    }`} />
                                <div className="relative bg-white/[0.02] backdrop-blur-xl border border-white/10 rounded-3xl p-8 group-hover:bg-white/[0.04] group-hover:border-white/20 transition-all duration-500">
                                    <div className="flex items-center gap-3 mb-6">
                                    ...
                                    <h3 className="text-3xl font-bold text-white mb-4 tracking-wide">
                                        Dynamic Development Mastery
                                    </h3>

                                    <p className="text-white/70 mb-6 leading-relaxed">
                                        Master building decentralized applications using simple framework with hands-on projects.
                                    </p>
                        ...
                        {/* Navigation Grid - Now with 5 cards */}
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
                            {navigationSections.map((section, index) => (
                                ...
                                >
                                    <div className={`absolute inset-0 bg-gradient-to-r ${section.gradient} transition-all duration-500 ${hoveredCard === section.key ? 'opacity-100 scale-105' : 'opacity-80'
                                        }`} />
                                    <div className={`absolute inset-0 bg-gradient-to-br from-white/10 to-transparent transition-opacity duration-300 ${hoveredCard === section.key ? 'opacity-100' : 'opacity-0'
                                        }`} />

                                    <div className="relative z-10 text-center">
                                        <div className={`w-16 h-16 mx-auto mb-4 bg-white/20 rounded-2xl flex items-center justify-center backdrop-blur-sm transition-all duration-300 ${hoveredCard === section.key ? 'scale-110' : ''
                                            }`}>
