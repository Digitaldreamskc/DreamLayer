                ...
                <div className="container mx-auto px-4 py-8">
                    ...
                    <div className="max-w-2xl mx-auto bg-white/[0.03] backdrop-blur-xl border border-white/10 rounded-3xl p-8">
                        {chainId !== STORY_CHAIN_ID && (
                            <div className="mb-6 p-6 rounded-xl bg-yellow-500/20 border border-yellow-500/30">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <h3 className="text-yellow-300 font-semibold mb-1">Network Required</h3>
                                    ...
                                    <button
                                        onClick={async () => {
                                            try {
                                                await switchChain({ chainId: STORY_CHAIN_ID });
                                                showToast.success('Network Switched', 'Successfully switched to Story Protocol');
                                            } catch (error) {
                                                showToast.error('Switch Failed', 'Please manually switch to Story Protocol in your wallet');
                                            }
                                        }}
                                        className="ml-4 px-4 py-2 bg-yellow-600 hover:bg-yellow-500 text-white rounded-lg font-medium transition-colors"
                                    >
                                        Switch Network
                                    </button>
                                </div>
