...
const modules = [
    {
        ...
        description: "Learn about Base's architecture, key features, and why it's Coinbase's L2 solution.",
        duration: "45 min",
        lessons: 5,
        difficulty: "Beginner",
    ...
    },
    {
        ...
        description: "Master Solidity programming language basics essential for Base development.",
        duration: "2 hours",
        lessons: 8,
    ...
    {
        id: 3,
        title: "Hardhat Framework",
        description: "Build Base applications using the Hardhat framework for faster development.",
        duration: "3 hours",
        lessons: 10,
        difficulty: "Intermediate",
        icon: <Code className="w-6 h-6" />,
        tags: ["Hardhat", "Smart Contracts", "Development"],
        color: "from-green-600 to-emerald-600"
    },
    {
        id: 4,
        title: "Smart Contract Development",
        description: "Create and deploy smart contracts on Base with best practices.",
        duration: "4 hours",
        lessons: 12,
        difficulty: "Advanced",
        icon: <Code className="w-6 h-6" />,
    ...
    },
    {
        ...
        description: "Integrate with Base DeFi protocols and build financial applications.",
        duration: "3 hours",
        lessons: 8,
        difficulty: "Advanced",
    ...
    },
    {
        ...
        description: "Create and manage NFT collections on Base using ERC standards.",
        duration: "2.5 hours",
        lessons: 7,
        difficulty: "Intermediate",
        icon: <Trophy className="w-6 h-6" />,
        tags: ["NFTs", "ERC", "Collections"],
        color: "from-pink-600 to-purple-600"
    }
];

export default function BaseLearningPath() {
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-950 via-gray-900 to-slate-950 relative overflow-hidden">
            ...
            <main className="container mx-auto px-4 py-8 relative z-10">
                <div className="max-w-4xl mx-auto">
                    ...
                    {/* Header */}
                    <div className="mb-8">
                        <h1 className="text-4xl font-bold text-white mb-2">Base Development</h1>
                        <p className="text-white/60">
                            Master Base's L2 blockchain. Learn Solidity, Hardhat, and build scalable dApps.
                        </p>
                    </div>
                            ...
                            <div className="grid grid-cols-3 gap-6">
                                <div>
                                    ...
                                    <div className="text-2xl font-bold text-white">
                                        {Math.round(userProgress.paths['base']?.overallProgress || 0)}%
                                    </div>
                                </div>
                                <div>
                                    <div className="text-white/60 text-sm mb-1">Completed Modules</div>
                                    <div className="text-2xl font-bold text-white">
                                        {Object.values(userProgress.paths['base']?.modules || {})
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {modules.map((module) => {
                            const moduleProgress = userProgress?.paths['base']?.modules[module.id.toString()];
