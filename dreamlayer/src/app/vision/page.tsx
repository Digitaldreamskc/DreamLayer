          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="mt-16 text-center">
              <div className="bg-gradient-to-r from-purple-600/20 to-pink-600/20 border border-purple-500/30 rounded-3xl p-8">
                <h3 className="text-2xl font-bold text-white mb-4">Register Your IP Assets</h3>
                <p className="text-white/70 mb-6">Turn your intellectual property into tradeable assets on Story Protocol</p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  <button className="bg-white/[0.05] hover:bg-white/[0.08] border border-white/20 hover:border-white/30 text-white px-8 py-3 rounded-xl font-semibold transition-all duration-300">
                    Learn More
                  </button>
                </div>
              </div>
